...
const CACHE_NAME = 'compare-text-v1';
const RUNTIME_CACHE = 'compare-text-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/compare-text/',
  '/compare-text/manifest.json',
  '/compare-text/icon-192.png',
  '/compare-text/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/compare-text/manifest.json';
}
