...
export const ui = {
  en: {
    ...
    clearAll: 'Clear both',
    expandEditor: 'Expand',
    editorAria: 'Text comparison editor',
    closeEditor: 'Close the editor',
    closeConfirmTitle: 'Close without saving?',
    closeConfirmBody: 'This clears both texts and the diff. This cannot be undone.',
  ...
  ja: {
    ...
    clearAll: '両方クリア',
    expandEditor: '全画面表示',
    editorAria: 'テキスト比較エディタ',
    closeEditor: 'エディタを閉じる',
    closeConfirmTitle: '保存せずに閉じますか？',
    closeConfirmBody: '両方のテキストと差分がクリアされます。この操作は取り消せません。',
  ...
  zh: {
    ...
    closeConfirmBody: '这会清空两侧文本及差异结果，且无法撤销。',
  ...
  de: {
    ...
    editorAria: 'Textvergleich-Editor',
    closeEditor: 'Editor schließen',
    closeConfirmTitle: 'Ohne Speichern schließen?',
    closeConfirmBody: 'Damit werden beide Texte und der Diff geleert. Das lässt sich nicht rückgängig machen.',
  ...
  es: {
    ...
    editorAria: 'Editor de comparación de texto',
    closeEditor: 'Cerrar el editor',
    closeConfirmTitle: '¿Cerrar sin guardar?',
    closeConfirmBody: 'Esto vacía ambos textos y la comparación. No se puede deshacer.',
